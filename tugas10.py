...
st.set_page_config(page_title="Color Palette Extractor", page_icon="🎨", layout="centered")
...
if uploaded_file is not None:
    ...
    st.caption(
        "Setiap titik mewakili satu piksel dari gambar, diproyeksikan ke 2D menggunakan PCA. "
        "Tanda ✕ adalah centroid akhir dari tiap klaster warna."
    )